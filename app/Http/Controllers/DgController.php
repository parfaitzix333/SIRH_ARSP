...
class DgController extends Controller
{
    ...
    public function les_contacts()
    {
        ...
        return view('dg.les_contacts', compact('user', 'les_contacts'));
    }
    ...
    public function les_communiques()
    {
        ...
        return view('dg.les_communiques', compact('user', 'les_communiques'));
    }
    ...
    public function les_posts()
    {
        ...
        return view('dg.les_posts', compact('user', 'les_posts'));
    }
    ...
    public function les_annees()
    {
        ...
        return view('dg.les_annees', compact('user', 'les_annees'));
    }
    ...
    public function historique()
    {
        ...
        return view('dg.historique', compact('user', 'historiques'));
    }
    ...
    public function les_reglements()
    {
        ...
        return view('dg.les_reglements', compact('user', 'les_reglements'));
    }
    ...
    public function les_utilisateurs()
    {
        ...
        return view('dg.les_utilisateurs', compact('user', 'les_utilisateurs'));
    }
