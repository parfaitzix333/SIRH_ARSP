...
class ChefServController extends Controller
{
    ...
    public function les_contacts()
    {
        ...
        return view('cs.les_contacts', compact('user', 'les_contacts'));
    }
    ...
    public function les_communiques()
    {
        ...
        return view('cs.les_communiques', compact('user', 'les_communiques'));
    }
    ...
    public function les_posts()
    {
        ...
        return view('cs.les_posts', compact('user', 'les_posts'));
    }
    ...
    public function les_annees()
    {
        ...
        return view('cs.les_annees', compact('user', 'les_annees'));
    }
    ...
    public function historique()
    {
        ...
        return view('cs.historique', compact('user', 'historiques'));
    }
    ...
    public function les_reglements()
    {
        ...
        return view('cs.les_reglements', compact('user', 'les_reglements'));
    }
    ...
    public function les_utilisateurs()
    {
        ...
        return view('cs.les_utilisateurs', compact('user', 'les_utilisateurs'));
    }
