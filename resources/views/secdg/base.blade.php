...
<body>
    ...
    <header class="header">
        ...
        <div class="header-right">
            ...
            <a href="{{ route('profile_secDg') }}" class="btn btn-outline-light btn-sm">
    ...
    <nav class="sidebar" id="sidebar">
        <a href="{{ route('accueil_secDg') }}"
            class="nav-item {{ request()->routeIs('accueil_secDg') ? 'active' : '' }}">
        ...
        <div class="nav-group" data-group="personnel">
            ...
            <div class="nav-group-items">
                <a href="{{ route('les_employes_SG') }}"
                    class="nav-item {{ request()->routeIs('les_employes_SG') ? 'active' : '' }}">
                    <i class="fas fa-users"></i> Employés
                </a>
                <a href="{{ route('les_affectations_SG') }}"
                    class="nav-item {{ request()->routeIs('les_affectations_SG') ? 'active' : '' }}">
                    <i class="fas fa-sitemap"></i> Affectations
                </a>
                <a href="{{ route('les_interims_SG') }}"
                    class="nav-item {{ request()->routeIs('les_interims_SG') ? 'active' : '' }}">
                    <i class="fas fa-user-tie"></i> Intérims
                </a>
                <a href="{{ route('les_presences_SG') }}"
                    class="nav-item {{ request()->routeIs('les_presences_SG') ? 'active' : '' }}">
                    <i class="fas fa-user-clock"></i> Présences
                </a>
                <a href="{{ route('les_performances_SG') }}"
                    class="nav-item {{ request()->routeIs('les_performances_SG') ? 'active' : '' }}">
                    <i class="fas fa-chart-line"></i> Performances
                </a>
                <a href="{{ route('les_dossiers_etude_SG') }}"
                    class="nav-item {{ request()->routeIs('les_dossiers_etude_SG') ? 'active' : '' }}">
                    <i class="fas fa-folder-open"></i> Dossiers d'étude
                </a>
                <a href="{{ route('les_archives_SG') }}"
                    class="nav-item {{ request()->routeIs('les_archives_SG') ? 'active' : '' }}">
                    <i class="fas fa-archive"></i> Archives
                </a>
                <a href="{{ route('les_formations_employes_SG') }}"
                    class="nav-item {{ request()->routeIs('les_formations_employes_SG') ? 'active' : '' }}">
                    <i class="fas fa-user-graduate"></i> Formations des employés
                </a>
                <a href="{{ route('les_mouvements_SG') }}"
                    class="nav-item {{ request()->routeIs('les_mouvements_SG') ? 'active' : '' }}">
        ...
        <div class="nav-group" data-group="conges">
            ...
            <div class="nav-group-items">
                <a href="{{ route('les_demandes_conge_SG') }}"
                    class="nav-item {{ request()->routeIs('les_demandes_conge_SG') ? 'active' : '' }}">
                    <i class="fas fa-file-signature"></i> Demandes de congé
                </a>
                <a href="{{ route('les_conges_SG') }}"
                    class="nav-item {{ request()->routeIs('les_conges_SG') ? 'active' : '' }}">
                    <i class="fas fa-umbrella-beach"></i> Types de congé
                </a>
                <a href="{{ route('les_disciplines_SG') }}"
        ...
        <div class="nav-group" data-group="referentiels">
            ...
            <div class="nav-group-items">
                <a href="{{ route('les_services_SG') }}"
                    class="nav-item {{ request()->routeIs('les_services_SG') ? 'active' : '' }}">
                    <i class="fas fa-building"></i> Services
                </a>
                <a href="{{ route('les_categories_SG') }}"
                ...
                <a href="{{ route('les_proprietes_SG') }}"
                    class="nav-item {{ request()->routeIs('les_proprietes_SG') ? 'active' : '' }}">
        ...
        <div class="nav-group" data-group="admin">
            ...
            <div class="nav-group-items">
                <a href="{{ route('les_utilisateurs_SG') }}"
                    class="nav-item {{ request()->routeIs('les_utilisateurs_SG') ? 'active' : '' }}">
                ...
                <a href="{{ route('les_audits_SG') }}"
                    class="nav-item {{ request()->routeIs('les_audits_SG') ? 'active' : '' }}">
                    <i class="fas fa-clipboard-check"></i> Audits
                </a>
                <a href="{{ route('historique_SG') }}"
                    class="nav-item {{ request()->routeIs('historique_SG') ? 'active' : '' }}">
                    <i class="fas fa-history"></i> Historiques
                </a>
                <a href="{{ route('les_communiques_SG') }}"
                    class="nav-item {{ request()->routeIs('les_communiques_SG') ? 'active' : '' }}">
