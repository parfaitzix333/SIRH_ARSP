    ...
    <style>
        ...
        * {
        ...
        /* ============================================
               ...
               ============================================ */
        .header {
            background: linear-gradient(135deg, #0d38f7 0%, #0804ff 100%);
            padding: 10px 20px;
            position: fixed;
            top: 0;
            left: 0;
...
<body>
    ...
    <nav class="sidebar" id="sidebar">
        <a href="{{ route('accueil_cs') }}" class="nav-item {{ request()->routeIs('accueil_cs') ? 'active' : '' }}">
        ...
        <div class="nav-group" data-group="personnel">
            ...
            <div class="nav-group-items">
                <a href="{{ route('les_employes_CS') }}"
                    class="nav-item {{ request()->routeIs('les_employes_CS') ? 'active' : '' }}">
                    <i class="fas fa-users"></i> Employés
                </a>
                <a href="{{ route('les_affectations_CS') }}"
                ...
                <a href="{{ route('les_performances_CS') }}"
                    class="nav-item {{ request()->routeIs('les_performances_CS') ? 'active' : '' }}">
                ...
                <a href="{{ route('les_archives_CS') }}"
                    class="nav-item {{ request()->routeIs('les_archives_CS') ? 'active' : '' }}">
                    <i class="fas fa-archive"></i> Archives
                </a>
                <a href="{{ route('les_formations_employes_CS') }}"
                    class="nav-item {{ request()->routeIs('les_formations_employes_CS') ? 'active' : '' }}">
                    <i class="fas fa-user-graduate"></i> Formations des employés
                </a>
                <a href="{{ route('les_mouvements_CS') }}"
                    class="nav-item {{ request()->routeIs('les_mouvements_CS') ? 'active' : '' }}">
        ...
        <div class="nav-group" data-group="referentiels">
            ...
            <div class="nav-group-items">
                <a href="{{ route('les_services_CS') }}"
                    class="nav-item {{ request()->routeIs('les_services_CS') ? 'active' : '' }}">
                    <i class="fas fa-building"></i> Services
                </a>
                <a href="{{ route('les_categories_CS') }}"
                    class="nav-item {{ request()->routeIs('les_categories_CS') ? 'active' : '' }}">
                ...
                <a href="{{ route('les_annees_CS') }}"
                    class="nav-item {{ request()->routeIs('les_annees_CS') ? 'active' : '' }}" hidden="True">
                    <i class="fas fa-calendar-alt"></i> Années
                </a>
                <a href="{{ route('les_reglements_CS') }}"
                    class="nav-item {{ request()->routeIs('les_reglements_CS') ? 'active' : '' }}">
                    <i class="fas fa-book"></i> Règlements
                </a>
                <a href="{{ route('les_proprietes_CS') }}"
                    class="nav-item {{ request()->routeIs('les_proprietes_CS') ? 'active' : '' }}" hidden="True">
        ...
        <div class="nav-group" data-group="admin">
            ...
            <div class="nav-group-items">
                ...
                <a href="{{ route('les_audits_CS') }}"
                    class="nav-item {{ request()->routeIs('les_audits_CS') ? 'active' : '' }}" hidden="True">
                ...
                <a href="{{ route('les_communiques_CS') }}"
                    class="nav-item {{ request()->routeIs('les_communiques_CS') ? 'active' : '' }}">
                    <i class="fas fa-bullhorn"></i> Communiqués
                </a>
                <a href="{{ route('les_contacts_CS') }}"
                    class="nav-item {{ request()->routeIs('les_contacts_CS') ? 'active' : '' }}">
